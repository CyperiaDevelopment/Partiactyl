...
module.exports.renderdataeval =
  `(async () => {
    ...
    let renderdata = {
      ...
      arcwidgets: arcjson.widgets,
      arcearnings: arcjson.earnings
    };
...
console.log(srt)
    console.log(chalk.green(figlet.textSync("Hexitactyl")));
    console.log(chalk.green("[HEXITACTYL] The client has successfully loaded on port " + listener.address().port + "."));
});
